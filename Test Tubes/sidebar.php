...
<head>
    ...
    <title>Aplikasi Kasir | by.kelompok 8</title>
...
<div class="page-wrapper chiller-theme toggled">
  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        <div class="user-pic" style="height:70px;width:70px;">
          <img class="img-responsive img-rounded" src="assets/images/admin.png"<?php echo $logo ?>"
            alt="User picture">
        </div>
        <div class="user-info">
    ...
    © 2024 Developed by - <a target="_blank" rel="noopener noreferrer" href="">
     Kelompok 8</a>
    </div>
  </nav>
  <!-- sidebar-wrapper  -->
