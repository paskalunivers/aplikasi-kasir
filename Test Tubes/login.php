...
<head>
    ...
    <title>Login Aplikasi Kasir | byKelompok 8</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      ...
      <p class="mt-3 mb-3 text-white">&copy; 2024 Developed by - <a target="_blank" rel="noopener noreferrer" href="" class="text-white">
     Kelompok 8 </a></p>
    </form>
